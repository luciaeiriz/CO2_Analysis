...
# mixtures = {"30CO2" : "64% TFE + 30% CO2 + 5% iC4H10 + 1% SF6",
#             "30CO205SF6" : "64.5% TFE + 30% CO2 + 5% iC4H10 + 0.5% SF6",
#             "40CO2" : "54% TFE + 40% CO2 + 5% iC4H10 + 1% SF6",
...
def plot_scan(scan):
    ...
    for wp, background_rate in background_rates.get(scan, []):
        labels.append(f"WP = {wp} [kV], Background rate at WP= {background_rate:.2f} Hz/cm2")
    label = '\n'.join(labels)
...
# Plotting 
label = "54% TFE + 40% CO2 + 5% iC4H10 + 1% SF6" #change label accordingly to gas mixture
