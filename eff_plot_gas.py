...
def plot_scan(scan):
    ...
    label = '\n'.join(labels)
    plt.errorbar(HV, eff, yerr=err*100, fmt=marker, markersize=11, color=color, label=label)
...
background_rates = read_background_rates('2024_data_atWP.csv')
plot_scan_colors = {}
plot_scan_markers = {}
...
plt.text(7400, 1.21+0.01, "GIF++", font0)
